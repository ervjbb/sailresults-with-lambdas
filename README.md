...
This is a practical example on how to add the use of a sail racing scoring system without having to change the basic regatta management function. They key to this is the use of lambda funtions in Kotlin.
