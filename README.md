...
The most commonly used way to score sailracing is to assign the same point as the placement in the race: the first boat gets the point 1, the second 2 and so forth.
